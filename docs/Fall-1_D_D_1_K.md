...
In diesem Szenario sind Frequenzen und Datengrößen stabil.
Die Besonderheit hier ist die Hardware-Beschränkung:
Wir arbeiten mit einer **Frame-Größe von 2 Bytes**.
Das bedeutet, jede Speicherallokation und jeder Datentransport muss ein Vielfaches dieser 2 Bytes sein.
...
> **Hinweis:** $K_{base} = S_{in} + S_{out}$ ist ein Double-Buffering-Prinzip,
> keine Queueing-Formel. Kleinrock (1975), Formel 2.29 definiert $\rho = \lambda/\mu$
> und wird erst ab Fall 2 relevant.
...
> Fall 1 ist der einzige vollstaendig deterministische Fall.
