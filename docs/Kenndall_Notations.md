...
> **Kein M (Markovian):** In diesem Projekt werden keine exponentiellen
> Ankunftsprozesse angenommen. Alle Variabilitätsquellen (Chunks, Frequenzen, Jitter)
> sind **begrenzt** (min/max bekannt) und werden als Gleichverteilung modelliert
> (Maximum Entropie Prinzip, Jaynes 2003). Daher: G, nicht M.


> **Methodische Praezisierung:** In diesem Projekt wird die Kendall Notation
> als Modell fuer den Producer/Consumer Zeitverlauf verwendet. Variable
> Chunk Grössen werden dabei als variable effektive Service, bzw. Arrival Demand
> interpretiert und in die Klasse G der jeweiligen A oder B-Seite überführt.
> Das ist eine zulässige Engineering Abstraktion für den Ring Buffer, keine
> wörtliche 1:1 Abbildung einer klassischen Paket-Queue.
